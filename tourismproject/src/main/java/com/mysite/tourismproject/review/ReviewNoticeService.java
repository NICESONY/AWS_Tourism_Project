...
public class ReviewNoticeService {
    ...
    public void createnotice(ReviewNotice notice, MultipartFile file1, MultipartFile file2, MultipartFile file3) throws IOException {
    ...
    public void update(ReviewNotice notice, MultipartFile file1, MultipartFile file2, MultipartFile file3) throws IOException{
        // 이미지 1만 변화가 있는 경우
        if (!file1.isEmpty()) { 
            s3Service.uploadFile(file1, file1.getOriginalFilename()); 
            notice.setImage1(file1.getOriginalFilename());
